...
public class battleActivity extends AppCompatActivity {
    ...
    double punch;
    double who;
    int fubasicattack = 10;
    int fusuperattack = 30;
    int ffbasicattack = 10;
    int ffsuperattack = 30;


    String[] plotstr = {"Вы пришли в подземелье и первым вы встретили стражника", "СТРАЖНИК: Кто вы такие и что вы забыли в нашем подземелье?", "ТЫ: мы пришли взять то, что давно принадлежит нашему Королевству- Знамя Веры, вы слишком долго скрывали его от нас", "СТРАЖНИК: Хотите получить Заветное Знамя...", "СТРАЖНИК: ТОЛЬКО ЧЕРЕЗ МОЙ ТРУП"};
    ...
    public void o() {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if (n==5 && epbar.getProgress()==0){

                    Intent intent = new Intent(battleActivity.this, gamemap.class);
                ...
                if (epbar.getProgress() <= 10) {
                    ...
                    //ты нажал на кнопку атаки, друг умер
                        ...
                        if (upbar.getProgress() != 0) {
                            ...
                            Intent intent = new Intent(battleActivity.this, GameOver.class);
                            startActivity(intent);
                        }
    ...
    public void fattack() {
        ...
        if (upbar.getProgress()!=0 && fpbar.getProgress()!=0) {
            ...
            if (punch>20 && who>50) {
                ...
                Toast.makeText(this,"СТРАЖНИК атакует по ТЕБЕ", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(this, "СТРАЖНИК атакует по АВГУСТУ", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(this,"СТРАЖНИК наносит по ТЕБЕ град ударов", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(this, "СТРАЖНИК наносит по АВГУСТУ град ударов", Toast.LENGTH_SHORT).show();
